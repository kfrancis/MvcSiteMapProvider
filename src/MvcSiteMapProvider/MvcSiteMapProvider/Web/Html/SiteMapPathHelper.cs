...
namespace MvcSiteMapProvider.Web.Html
{
    ...
    public static class SiteMapPathHelper
    {
        ...
        /// <returns>SiteMap path for the current request</returns>
        public static MvcHtmlString SiteMapPath(this MvcSiteMapHtmlHelper helper, string templateName,
            string startingNodeKey, object sourceMetadata)
        {
        ...
        /// <param name="sourceMetadata">User-defined meta data.</param>
        /// <returns>SiteMap path for the current request</returns>
        private static MvcHtmlString SiteMapPath(this MvcSiteMapHtmlHelper helper, string templateName,
            string startingNodeKey, SourceMetadataDictionary sourceMetadata)
        {
            var startingNode = string.IsNullOrEmpty(startingNodeKey)
                ? helper.SiteMap.CurrentNode
                : helper.SiteMap.FindSiteMapNodeFromKey(startingNodeKey);
        ...
        /// <returns>SiteMap path for the current request</returns>
        public static MvcHtmlString SiteMapPath(this MvcSiteMapHtmlHelper helper, string templateName,
            ISiteMapNode startingNode, object sourceMetadata)
        {
        ...
        /// <returns>SiteMap path for the current request</returns>
        public static MvcHtmlString SiteMapPath(this MvcSiteMapHtmlHelper helper, string templateName,
            ISiteMapNode startingNode, SourceMetadataDictionary sourceMetadata)
        {
        ...
        private static SiteMapPathHelperModel BuildModel(MvcSiteMapHtmlHelper helper,
            SourceMetadataDictionary sourceMetadata, ISiteMapNode startingNode)
        {
            // Build model

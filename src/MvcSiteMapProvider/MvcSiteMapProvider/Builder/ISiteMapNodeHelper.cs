...
public interface ISiteMapNodeHelper
{
    ...
    string CreateNodeKey(string parentKey, string key, string url, string title, string area, string controller,
        string action, string httpMethod, bool clickable);
    ...
    ///     A string description of the provider. This value is shown in exception messages related to the
    ///     node configuration.
    /// </param>
    ...
    /// <summary>
    ///     Processes the dynamic nodes and builds them into a list of
    ///     <see cref="T:MvcSiteMapNodeProvider.Builder.ISiteMapNodeToParentRelation" /> instances
    ...
    /// <returns>
    ///     A
    ///     <see cref="T:System.Collections.Generic.IEnumerable`MvcSiteMapNodeProvider.Builder.ISiteMapNodeToParentRelation`" />
    ///     instance.
    /// </returns>

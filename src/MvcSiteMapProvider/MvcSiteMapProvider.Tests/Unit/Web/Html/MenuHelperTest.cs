...
namespace MvcSiteMapProvider.Tests.Unit.Web.Html
{
    ...
    public class MenuHelperTest
    {
        ...
        public void BuildModel_Case1_DontShowStartingNode_ShouldReturnAllNodesAtRootLevelWithoutStartingNode()
        {
            ...
            // Assert
            Assert.That("About", Is.EqualTo(result.Nodes[0].Title));
            Assert.That("Contact", Is.EqualTo(result.Nodes[1].Title));
        ...
        public void BuildModel_Case2_StartingNodeNotInChildLevel_MaxDepth1_ShouldReturnHierarchialNodesTo1Levels()
        {
            ...
            Assert.That(1, Is.EqualTo(result.Nodes.Count));
            Assert.That(2, Is.EqualTo(result.Nodes[0].Children.Count)); // Home
            Assert.That(0, Is.EqualTo(result.Nodes[0].Children[0].Children.Count)); // About
            Assert.That(0, Is.EqualTo(result.Nodes[0].Children[1].Children.Count)); // Categories
        ...
        public void BuildModel_Case2_StartingNodeNotInChildLevel_MaxDepth2_ShouldReturnHierarchialNodesTo2Levels()
        {
            ...
            Assert.That(0, Is.EqualTo(result.Nodes[0].Children[0].Children[0].Children.Count)); // About Me
            Assert.That(0, Is.EqualTo(result.Nodes[0].Children[0].Children[1].Children.Count)); // About You
            Assert.That(1, Is.EqualTo(result.Nodes[0].Children[1].Children.Count)); // Categories
            Assert.That(0, Is.EqualTo(result.Nodes[0].Children[1].Children[0].Children.Count)); // Cameras
        }
        ...
        public void BuildModel_Case3_CurrentNodeNotVisible_StartingNodeInChildLevel_NotShowStartingNode_MaxDepth1_visibilityNotAffectsDescendants_ShouldReturn3Nodes()
        {
            ...
            // Assert
            Assert.That("AAA", Is.EqualTo(result.Nodes[0].Title));
            Assert.That("AAB", Is.EqualTo(result.Nodes[1].Title));
            Assert.That("AAC", Is.EqualTo(result.Nodes[2].Title));
        ...
        public void BuildModel_Case3_CurrentNodeNotVisible_StartingNodeInChildLevel_NotShowStartingNode_MaxDepth2_visibilityNotAffectsDescendants_ShouldReturn3Nodes()
        {
            ...
            // Check counts
            Assert.That(3, Is.EqualTo(result.Nodes.Count));
            Assert.That(1, Is.EqualTo(result.Nodes[0].Children.Count));
            Assert.That(0, Is.EqualTo(result.Nodes[1].Children.Count));
            Assert.That(0, Is.EqualTo(result.Nodes[2].Children.Count));
        }
        ...
        public void BuildModel_Case3_CurrentNodeNotVisible_ChildNodesNotVisible_StartingNodeInChildLevel_NotShowStartingNode_MaxDepth1_visibilityNotAffectsDescendants_ShouldReturn0Nodes()
        {
            ...
            // Check counts
            Assert.That(0, Is.EqualTo(result.Nodes.Count));
        }
        ...
        public void BuildModel_Case3_CurrentNodeNotVisible_StartingNodeInChildLevel_NotShowStartingNode_MaxDepth2_visibilityNotAffectsDescendants_ShouldReturn4Nodes()
        {
            ...
            // Assert
            Assert.That("ABAA", Is.EqualTo(result.Nodes[0].Title));
            Assert.That("ABAB", Is.EqualTo(result.Nodes[1].Title));
            Assert.That("ABB", Is.EqualTo(result.Nodes[2].Title));
            Assert.That("ABC", Is.EqualTo(result.Nodes[3].Title));

            // Check counts
            Assert.That(4, Is.EqualTo(result.Nodes.Count));
            Assert.That(0, Is.EqualTo(result.Nodes[0].Children.Count));
            Assert.That(0, Is.EqualTo(result.Nodes[1].Children.Count));
            Assert.That(0, Is.EqualTo(result.Nodes[2].Children.Count));
            Assert.That(0, Is.EqualTo(result.Nodes[3].Children.Count));
        }
        ...
        public void BuildModel_Case3_CurrentNodeNotVisible_StartingNodeInChildLevel_NotShowStartingNode_MaxDepth2_visibilityNotAffectsDescendants_ShouldReturn2Nodes()
        {
            ...
            // Assert
            Assert.That("ADB", Is.EqualTo(result.Nodes[0].Title));
            Assert.That("ADC", Is.EqualTo(result.Nodes[1].Title));

            // Check counts
            Assert.That(2, Is.EqualTo(result.Nodes.Count));
            Assert.That(0, Is.EqualTo(result.Nodes[0].Children.Count));
            Assert.That(0, Is.EqualTo(result.Nodes[1].Children.Count));
        }
